...
/// Core routes — work with any PoiRepository backend (PostgreSQL or SQLite)
...
/// PostgreSQL-only routes (evaluation + PostGIS coverage)
pub fn create_pg_router(pool: PgPool) -> Router {
    Router::new()
